    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <p><a class="btn btn-lg btn-success" style= "background-color: darkcyan;" href="logout.php" role="button">Log out</a></p>
        ...
        <div class="row featurette">
		  ...
		  <h1>Agora</h1>
          <p class="lead">İzmir Agorası veya Smyrna Agorası, günümüzde İzmir'in Konak ilçesinde bulunan ve MÖ 4. yüzyılda kurulan agoradır. Zamanında kentin devlet agorası olarak işlev gördü. MS 178'te meydana gelen depremin ardından Roma İmparatoru Marcus Aurelius'un desteğiyle yeniden inşa edildi. Osmanlı döneminde mezarlık ve namazgâh olarak kullanıldı. Bölgedeki ilk kazı çalışmaları 1932'de gerçekleştirildi. İzmir Agorası, 2020'de UNESCO tarafından "İzmir Tarihî Liman Kenti" adıyla oluşturulan miras alanının bir parçası olarak Dünya Mirası Geçici Listesi'ne dahil edildi.</p>
		  </div>
          <div class="col-md-5 order-md-1">
            <img class="featurette-image img-fluid mx-auto" src="img/agora.jpeg" alt="Generic placeholder image">
          </div>
        </div>
