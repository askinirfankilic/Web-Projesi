    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <p><a class="btn btn-lg btn-success" style= "background-color: darkcyan;" href="logout.php" role="button">Log out</a></p>
        ...
        <div class="row featurette">
          <div class="col-md-7">
			<h1>Dünya Barış Anıtı</h1>
            <p class="lead">Dünya Barış Anıtı, İzmir'in Karşıyaka Belediyesi'nce, Sivas'ta 1993 yılında yaşanan Sivas Katliamı yangınında hayatını kaybeden 33 aydının anısına Orgeneral Nafiz Gürman Mahallesi'nde yaptırılan anıttır. Yerel seçimler öncesinde çıkartılan 5747 Sayılı Bölünme Yasası kapsamında Bayraklı Belediyesi'ne geçmiştir.</p>
          </div>
          <div class="col-md-5">
            <img class="featurette-image img-fluid mx-auto" src="img/baris.jpg" alt="Generic placeholder image">
          </div>
        </div>
